...
namespace Acme.Emenu.Migrations
{
    ...
    [Migration("20240125090546_variantsupdate")]
    partial class variantsupdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.AttributeOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.AttributeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.ProductAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.ProductTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.Variant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.VariantAttributeOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.AttributeOption", b =>
                {
                    b.HasOne("Acme.Emenu.Entities.AttributeType", "AttributeType")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.ProductAttribute", b =>
                {
                    ...
                    b.HasOne("Acme.Emenu.Entities.Product", "Product")
                        .WithMany("Attributes")
            ...
            modelBuilder.Entity("Acme.Emenu.Entities.VariantAttributeOption", b =>
                {
                    b.HasOne("Acme.Emenu.Entities.AttributeOption", "AttributeOption")
                        .WithMany()
                        .HasForeignKey("AttributeOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.Emenu.Entities.Variant", "Variant")
